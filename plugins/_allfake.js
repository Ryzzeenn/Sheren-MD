		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					body: wm,
					mediaUrl: sgh,
					description: 'Sheren-MD',
					previewType: "PHOTO",
					thumbnail: fs.readFileSync("./thumbnail.jpg"),
					sourceUrl: "https://github.com/Shinz-06",					
				}
			}
		}
		global.fakeig = {
...
global.fakeegc = {
		...
		global.fkontak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': wm, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${wm},;;;\nFN:${wm},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./thumb.jpg'), thumbnail: fs.readFileSync('./thumb.jpg'),sendEphemeral: true}}}
        global.fvn = {
            key: { 
                 fromMe: false,
            ...
            message: { "liveLocationMessage": { "caption":"by : Papah-Chan","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumb.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "Papah-Chan","h": wm, 'jpegThumbnail': fs.readFileSync('./thumb.jpg')}}
           }
               ...
               message: {
                   "productMessage": {
                       "product": {
                           "productImage":{
                               "mimetype": "image/jpeg",
                               "jpegThumbnail": fs.readFileSync('./thumb.jpg') //Gambarnye
                           },
